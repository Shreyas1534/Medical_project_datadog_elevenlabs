...
# ----------------------------------------
# 🧠 REAL MEDICAL REPORT FROM GROQ (not static)
# ----------------------------------------
...
{{
  ...
  "severity_assessment": "Choose one: Low / Moderate / High clinical concern",
  "potential_symptoms": ["list realistic symptoms related to this condition"],
  "recommended_medical_tests": ["MRI", "CT Scan", "Blood panel", ...],
  "doctor_specialist_required": "Which specialist to consult?",
  "treatment_guidance": [
    "first-line advice",
    "diagnostic step",
    "treatment or monitoring advice"
  ],
  "emergency_risk_signs": [
    "signs the patient MUST NOT ignore",
    "when to go to ER"
  ],
  "patient_friendly_summary": "Explain like a doctor is talking to a patient.",
...
"""
    ...
    res = client.chat.completions.create(
        model="llama-3.1-70b-versatile",    # 🔥 strongest available Groq model for medical text
        messages=[{"role":"system","content":"You are a professional medical diagnostic assistant."},
